...
const DoctorCard = ({ name, speciality, experience, ratings, profilePic }) => {
  ...
  const handleCancel = (appointmentId) => {
    ...
    window.localStorage.removeItem("doctorSpeciality");      
    window.localStorage.removeItem("patienrName");
    window.localStorage.removeItem("patientPhone");
    window.localStorage.removeItem("appointmentDate");
    window.localStorage.removeItem("appointmentTime");
